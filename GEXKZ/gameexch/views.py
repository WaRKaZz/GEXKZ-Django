...
class GameDetailView(DetailView):
	...
	def get_context_data(self, **kwargs):
		...
		context['comments'] = GameComment.objects.filter(game=self.get_object()).order_by('-id')
...
class GameCommentDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
	model = GameComment
	
	def get_success_url(self):
		return reverse('gex-game-datail', kwargs={'pk': self.get_object().game.id})
